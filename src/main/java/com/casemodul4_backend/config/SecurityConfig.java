...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().ignoringAntMatchers("/**","/login"); //Cho phép tất cả các đường dẫn đều truy cập được bằng Get và Post
        http.authorizeRequests().antMatchers("/register").permitAll() //Phân quyền_cho phép các đường dẫn trên được truy cập
